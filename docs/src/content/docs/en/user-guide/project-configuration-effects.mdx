...
| [Rename](../features/rename/) and [Automatic Refactoring](../features/quick-fixes/) | Local code actions stay available, and rename works only when all edits are proven to stay in the current file; cross-file rename requires `vide.toml` | Fills or converts ports and parameters across the project, and updates declarations, references, and connections |
