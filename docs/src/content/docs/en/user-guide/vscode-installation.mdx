...
This page helps you install the Vide VS Code extension and verify that it is working. If you have not installed VS Code yet, download it from the [VS Code website](https://code.visualstudio.com/).
