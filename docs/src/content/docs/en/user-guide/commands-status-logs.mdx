...
This page lists commands, status bar meanings, and output channels contributed by the Vide VS Code extension. For failures, start with [Troubleshooting and Bug Reports](../../advanced-guide/troubleshooting/).
