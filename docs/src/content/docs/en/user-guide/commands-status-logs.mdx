...
description: Vide command IDs, status item meanings, and output channel reference.
---

import Codicon from '../../../../components/Codicon.astro';

This page lists the commands, status bar states, and output channels contributed by the Vide VS Code extension. For startup failures, start with [Server Self-Check](../../advanced-guide/check-server/). For deeper troubleshooting, use [Advanced Troubleshooting](../../advanced-guide/troubleshooting/).

## Command Palette Commands

The VS Code extension contributes these commands. Use the Command Palette title in daily work; command IDs are mainly for keybindings and scripts.
...
## Server Startup Setting Changes
