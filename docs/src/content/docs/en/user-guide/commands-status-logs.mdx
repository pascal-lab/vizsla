...
This page lists commands, status bar meanings, and output channels contributed by the Vide VS Code extension. For startup failures, start with [Server Self-Check](../../advanced-guide/check-server/). For deeper troubleshooting, use [Advanced Troubleshooting](../../advanced-guide/troubleshooting/).
