...
<VizslaLab
  ...
  description="This example passes vizsla.toml, an include file, and RTL files directly from the docs page. Try removing include_dirs or a macro definition and watch diagnostics and semantic information change."
/>
