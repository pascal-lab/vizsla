...
Use this page only as an entry-point reference, not as a troubleshooting flow. To check whether the server starts correctly, follow [Server Self-Check Flow](../check-server/). For advanced failures, use [Advanced Troubleshooting](../troubleshooting/).
