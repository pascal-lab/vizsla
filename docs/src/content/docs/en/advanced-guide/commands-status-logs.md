...
Use this page as an operations reference. To check whether the server starts correctly, follow [Server Self-Check Flow](../check-server/). For advanced failures, use [Advanced Troubleshooting](../troubleshooting/).
