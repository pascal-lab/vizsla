    ...
    return [
      {
        ...
        description: `Use ${accent('Go to Definition')}, ${accent('Find References')}, and ${accent('Document Symbols')} in Vide to move quickly across modules, ports, and registers, tracing RTL connections without leaving the current context.<br /><br />Writing RTL no longer has to start with Ctrl + F.`,
      ...
      },
      {
        ...
        eyebrow: 'Insight',
        title: 'Code Insight',
        description: `Use Vide ${accent('Hover')} and ${accent('Inlay Hints')} to inspect modules, literals, and port connections in one editor window, with less window switching and more focus on the RTL design itself.`,
      ...
      },
      {
        ...
        description: `Vide ${accent('Completion')} understands the current code context, suggests candidates suited to instantiations, port connections, and other editing positions, and provides structured edits with ${accent('Snippets')}.`,
      ...
      },
      {
        ...
        description: `With ${accent('Automatic Refactoring')} and ${accent('Rename')}, Vide handles repetitive details such as port wiring, signal renames, and literal-base conversion, making RTL refactoring less manual.`,
