...
mod tests {
    ...
    fn setup_multi_file_diagnostics_test(
        ...
        for (path, text) in files {
            ...
            uris.push(to_proto::url_from_abs_path(
                AbsPathBuf::assert_utf8(file_path.clone()).as_ref(),
            ));
        }
...
";
    ...
    fn document_diagnostic_result_id_changes_when_dependency_changes() {
        ...
        let fixed_child_text = "module child(input logic a);\nendmodule\n";
        client
            .sender
            .send(Message::Notification(Notification::new(
                ...
                DidChangeTextDocumentParams {
                    ...
                    content_changes: vec![TextDocumentContentChangeEvent {
                        range: None,
                        range_length: None,
                        text: fixed_child_text.to_string(),
                    }],
                },
            )))
            .unwrap();
