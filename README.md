...
Vide is a fully open-source modern SystemVerilog coding IDE developed by [PASCAL group](https://pascal-lab.net/) at Nanjing University, designed to make hardware design feel as fluid as software development. Vide brings more than a dozen code analysis capabilities that traditional hardware IDEs often lack, such as [definition navigation](https://vide.pascal-lab.net/en/user-guide/features/navigation/), [annotations](https://vide.pascal-lab.net/en/user-guide/features/annotations/), [precise completion](https://vide.pascal-lab.net/en/user-guide/features/completion/), and [automatic refactoring](https://vide.pascal-lab.net/en/user-guide/features/quick-fixes/). With Vide, hardware developers can understand, write, and maintain Verilog/SystemVerilog code more efficiently.
