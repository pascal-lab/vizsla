...
static std::optional<SyntaxKeywordContext> keywordContextForMemberParent(SyntaxKind parentKind) {
    switch (parentKind) {
        case SyntaxKind::CompilationUnit:
            return SyntaxKeywordContext::CompilationUnitMember;
        case SyntaxKind::LibraryMap:
            return SyntaxKeywordContext::LibraryMapMember;
        case SyntaxKind::ModuleDeclaration:
        case SyntaxKind::InterfaceDeclaration:
        case SyntaxKind::ProgramDeclaration:
        case SyntaxKind::AnonymousProgram:
            return SyntaxKeywordContext::ModuleMember;
        case SyntaxKind::GenerateRegion:
        case SyntaxKind::GenerateBlock:
            return SyntaxKeywordContext::GenerateMember;
        case SyntaxKind::SpecifyBlock:
            return SyntaxKeywordContext::SpecifyItem;
        default:
            return std::nullopt;
    }
}
...
std::span<TMember*> Parser::parseMemberList(TokenKind endKind, Token& endToken,
    ...
    while (true) {
        auto kind = peek().kind;
        recordExpectedSyntax(diag::ExpectedMember, TokenKind::Unknown,
                             keywordContextForMemberParent(parentKind));
...
ConfigDeclarationSyntax& Parser::parseConfigDeclaration(AttrList attributes) {
    ...
    while (true) {
        ...
        if (!peek(TokenKind::LocalParamKeyword))
            break;
