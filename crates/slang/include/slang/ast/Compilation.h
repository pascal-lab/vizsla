...
public:
    ...
    /// Gets all registered system function names that are available for system identifier lookup.
    std::vector<std::string> getSystemFunctionNames() const;

    /// Gets all registered system task names that are available for system identifier lookup.
    std::vector<std::string> getSystemTaskNames() const;
