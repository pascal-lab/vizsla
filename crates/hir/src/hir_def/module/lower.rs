use crate::{
    hir_def::{
        data::{
            self, DataSubDecl, DataType, LocalDataSubDeclSrc, LocalParamPortDeclSrc,
            LowerDataSubDecl, LowerDataType, LowerDimension, LowerParamDecl, NetKind, ParamDecl,
        },
